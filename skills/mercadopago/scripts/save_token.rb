# Save the MercadoPago Access Token
...
uri = URI('https://api.mercadopago.com/v1/payment_methods')
...
token_dir  = File.expand_path('~/.config/mercadopago')
...
methods = JSON.parse(resp.body)
puts "Verified: #{methods.length} payment methods available"
